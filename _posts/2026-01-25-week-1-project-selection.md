---
title: "Week 1: Project Selection and Initial Research"
...
Hey there! Welcome to the first post of what I hope will be a really insightful journey through my final year project. I'm Oluwatunmise Raphael Shuaibu, a BEng Mechatronics and Robotics Engineering student at Middlesex University London, and this blog is going to document every step of building a **Perception and SLAM System for Autonomous Racing**.

This week has been all about laying the foundation—choosing the right project, doing initial research, and getting everything set up for the work ahead. Let me walk you through it!

## The Big Decision: Choosing My Project

Honestly, choosing a final year project is kind of a big deal. This is something I'll be working on for months, so it had to be something that would challenge me, teach me new skills, and ideally be something I'd actually enjoy working on.
...
You can check out my full project proposal here if you're curious about the technical details:

📄 [Download Project Proposal (PDF)](/fyp-perception-slam/assets/docs/Project_Proposal_M00960413.pdf)

## What Did I Actually Do in Week 1?

Week 1 was all about research and planning. Here's what I got up to:

###  Literature Review
I dove into academic papers to understand the fundamentals of perception systems and SLAM (Simultaneous Localization and Mapping). There's a lot of existing research in this space, and I wanted to understand what approaches have been tried, what works well, and where the challenges are.

If you're interested in what I've been reading, check out my [Literature Review](/fyp-perception-slam/literature-review/) page—I'll be updating it as I go.

###  Discussions with Teachers and Advisors
...
So what's next? Week 2 is where the real work begins. Here's what I'm planning:
...
Week 1 has been a solid start. I've got a clear plan, I understand the problem space better, and I'm ready to dive into implementation. There's definitely a lot to learn, and I'm sure I'll hit some roadblocks along the way, but that's part of the process.
